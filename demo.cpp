...
void test_simple() {
    ...
    assert_true(((input * output - Eigen::MatrixXd::Identity(input.rows(), output.cols())).array().abs() < TOL)
        .all(), "Bad pseudoinverse");
    Eigen::internal::set_is_malloc_allowed(false);
}
...
void test1() {
    ...
    Eigen::internal::set_is_malloc_allowed(true);
    assert_true((output - expected).array().abs().maxCoeff() < TOL, "Bad psuedoinverse");
    Eigen::internal::set_is_malloc_allowed(false);
}
...
void test3() {
    ...
    expected << -2.00000000e-01, -1.07692308e-01, -1.53846154e-02, 7.69230769e-02, 7.69230769e-02, 
        1.69230769e-01,
        6.00000000e-01, 4.00000000e-01, 2.00000000e-01, 4.16333634e-17, 4.16333634e-17, -2.00000000e-01;
